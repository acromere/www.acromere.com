	...
	return (
		<div className='content'>
          ...
          <a href='/product/xenon'><span className="product-icon">{Icon.XENON}</span></a>
				...
				<div className='product-bar'>
					<a href='/product/cartesia'><span className="product-icon">{Icon.CARTA}</span></a>
					<div className='body'>
						<div>
				...
				<div className='product-bar'>
					<a href='/product/acorn'><span className="product-icon">{Icon.ACORN}</span></a>
					<div className='body'>
				...
				<div className='product-bar'>
					<a href='/product/seenc'><span className="product-icon">{Icon.SEENC}</span></a>
					<div className='body'>
